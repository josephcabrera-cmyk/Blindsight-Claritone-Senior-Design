...
/*
 * The custom Claritone PCB bring-up target is intentionally headless.
 * Keep the LCD helper interface available as a lightweight stub so stale
 * managed-build entries do not pull in the full LCD stack.
 */
typedef enum
{
  CENTER_MODE = 0x01,
